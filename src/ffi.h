...
using napi_finalize_t = node_api_basic_finalize;
#else
using napi_finalize_t = napi_finalize;
#endif
...
struct callback_info {
    ...
    FunctionReference errorFunction;    // JS callback function for reporting exceptions
    FunctionReference function;         // JS callback function the closure represents
    int argc;                      // number of arguments
    size_t resultSize;             // result pointer size
